...
A data quality monitoring system for autonomous driving datasets, built to detect data drift, enforce schema validation, and automatically quarantine corrupt data, all orchestrated with Dagster and running entirely on Docker.
